...
const QuickActionCard: React.FC<QuickActionCardProps> = ({ icon: IconComponent, label }) => {
  return (
    <TouchableOpacity className="aspect-square flex-1 bg-white rounded-xl items-center justify-center m-1 p-2 shadow-sm">
